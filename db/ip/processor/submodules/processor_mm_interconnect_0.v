...
module processor_mm_interconnect_0 (
		...
		output wire        swap_s1_write,                                  //                                         .write
		input  wire [31:0] swap_s1_readdata,                               //                                         .readdata
		output wire [31:0] swap_s1_writedata,                              //                                         .writedata
		output wire        swap_s1_chipselect,                             //                                         .chipselect
	...
	wire  [16:0] done_s1_agent_m0_address;                                                           // done_s1_agent:m0_address -> done_s1_translator:uav_address
	...
	wire  [93:0] done_s1_agent_rf_source_data;                                                       // done_s1_agent:rf_source_data -> done_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] done_s1_agent_rsp_fifo_out_data;                                                    // done_s1_agent_rsp_fifo:out_data -> done_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> done_s1_agent:cp_valid
	wire  [92:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> done_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // done_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> done_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> done_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> done_s1_agent:cp_endofpacket
	...
	wire  [16:0] swap_s1_agent_m0_address;                                                           // swap_s1_agent:m0_address -> swap_s1_translator:uav_address
	...
	wire  [93:0] swap_s1_agent_rf_source_data;                                                       // swap_s1_agent:rf_source_data -> swap_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] swap_s1_agent_rsp_fifo_out_data;                                                    // swap_s1_agent_rsp_fifo:out_data -> swap_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> swap_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> swap_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // swap_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> swap_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> swap_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> swap_s1_agent:cp_endofpacket
	...
	wire  [16:0] bb_we_s1_agent_m0_address;                                                          // bb_we_s1_agent:m0_address -> bb_we_s1_translator:uav_address
	...
	wire  [93:0] bb_we_s1_agent_rf_source_data;                                                      // bb_we_s1_agent:rf_source_data -> bb_we_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] bb_we_s1_agent_rsp_fifo_out_data;                                                   // bb_we_s1_agent_rsp_fifo:out_data -> bb_we_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> bb_we_s1_agent:cp_valid
	wire  [92:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> bb_we_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // bb_we_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> bb_we_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> bb_we_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> bb_we_s1_agent:cp_endofpacket
	...
	wire  [16:0] waddr_s1_agent_m0_address;                                                          // waddr_s1_agent:m0_address -> waddr_s1_translator:uav_address
	...
	wire  [93:0] waddr_s1_agent_rf_source_data;                                                      // waddr_s1_agent:rf_source_data -> waddr_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] waddr_s1_agent_rsp_fifo_out_data;                                                   // waddr_s1_agent_rsp_fifo:out_data -> waddr_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> waddr_s1_agent:cp_valid
	wire  [92:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> waddr_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // waddr_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> waddr_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> waddr_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> waddr_s1_agent:cp_endofpacket
	...
	wire  [16:0] din_s1_agent_m0_address;                                                            // din_s1_agent:m0_address -> din_s1_translator:uav_address
	...
	wire  [93:0] din_s1_agent_rf_source_data;                                                        // din_s1_agent:rf_source_data -> din_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] din_s1_agent_rsp_fifo_out_data;                                                     // din_s1_agent_rsp_fifo:out_data -> din_s1_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> din_s1_agent:cp_valid
	wire  [92:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> din_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // din_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> din_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> din_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> din_s1_agent:cp_endofpacket
	...
	wire         done_s1_agent_rp_valid;                                                             // done_s1_agent:rp_valid -> router_005:sink_valid
	wire  [92:0] done_s1_agent_rp_data;                                                              // done_s1_agent:rp_data -> router_005:sink_data
	wire         done_s1_agent_rp_ready;                                                             // router_005:sink_ready -> done_s1_agent:rp_ready
	wire         done_s1_agent_rp_startofpacket;                                                     // done_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         done_s1_agent_rp_endofpacket;                                                       // done_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         swap_s1_agent_rp_valid;                                                             // swap_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] swap_s1_agent_rp_data;                                                              // swap_s1_agent:rp_data -> router_006:sink_data
	wire         swap_s1_agent_rp_ready;                                                             // router_006:sink_ready -> swap_s1_agent:rp_ready
	wire         swap_s1_agent_rp_startofpacket;                                                     // swap_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         swap_s1_agent_rp_endofpacket;                                                       // swap_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         bb_we_s1_agent_rp_valid;                                                            // bb_we_s1_agent:rp_valid -> router_007:sink_valid
	wire  [92:0] bb_we_s1_agent_rp_data;                                                             // bb_we_s1_agent:rp_data -> router_007:sink_data
	wire         bb_we_s1_agent_rp_ready;                                                            // router_007:sink_ready -> bb_we_s1_agent:rp_ready
	wire         bb_we_s1_agent_rp_startofpacket;                                                    // bb_we_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         bb_we_s1_agent_rp_endofpacket;                                                      // bb_we_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         waddr_s1_agent_rp_valid;                                                            // waddr_s1_agent:rp_valid -> router_008:sink_valid
	wire  [92:0] waddr_s1_agent_rp_data;                                                             // waddr_s1_agent:rp_data -> router_008:sink_data
	wire         waddr_s1_agent_rp_ready;                                                            // router_008:sink_ready -> waddr_s1_agent:rp_ready
	wire         waddr_s1_agent_rp_startofpacket;                                                    // waddr_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         waddr_s1_agent_rp_endofpacket;                                                      // waddr_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         din_s1_agent_rp_valid;                                                              // din_s1_agent:rp_valid -> router_009:sink_valid
	wire  [92:0] din_s1_agent_rp_data;                                                               // din_s1_agent:rp_data -> router_009:sink_data
	wire         din_s1_agent_rp_ready;                                                              // router_009:sink_ready -> din_s1_agent:rp_ready
	wire         din_s1_agent_rp_startofpacket;                                                      // din_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         din_s1_agent_rp_endofpacket;                                                        // din_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         done_s1_agent_rdata_fifo_src_valid;                                                 // done_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] done_s1_agent_rdata_fifo_src_data;                                                  // done_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         done_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_003:in_0_ready -> done_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> done_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> done_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // done_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> done_s1_agent:rdata_fifo_sink_error
	wire         swap_s1_agent_rdata_fifo_src_valid;                                                 // swap_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] swap_s1_agent_rdata_fifo_src_data;                                                  // swap_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         swap_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_004:in_0_ready -> swap_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> swap_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> swap_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // swap_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> swap_s1_agent:rdata_fifo_sink_error
	wire         bb_we_s1_agent_rdata_fifo_src_valid;                                                // bb_we_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] bb_we_s1_agent_rdata_fifo_src_data;                                                 // bb_we_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         bb_we_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_005:in_0_ready -> bb_we_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> bb_we_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> bb_we_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // bb_we_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> bb_we_s1_agent:rdata_fifo_sink_error
	wire         waddr_s1_agent_rdata_fifo_src_valid;                                                // waddr_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] waddr_s1_agent_rdata_fifo_src_data;                                                 // waddr_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         waddr_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_006:in_0_ready -> waddr_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> waddr_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> waddr_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // waddr_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> waddr_s1_agent:rdata_fifo_sink_error
	wire         din_s1_agent_rdata_fifo_src_valid;                                                  // din_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] din_s1_agent_rdata_fifo_src_data;                                                   // din_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         din_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_007:in_0_ready -> din_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> din_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> din_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                  // din_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> din_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.av_write               (swap_s1_write),                                  //                         .write
		.av_readdata            (swap_s1_readdata),                               //                         .readdata
		.av_writedata           (swap_s1_writedata),                              //                         .writedata
		.av_chipselect          (swap_s1_chipselect),                             //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
