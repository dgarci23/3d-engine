...
module processor_mm_interconnect_0 (
	...
	wire  [96:0] done_s1_agent_rf_source_data;                                                       // done_s1_agent:rf_source_data -> done_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] done_s1_agent_rsp_fifo_out_data;                                                    // done_s1_agent_rsp_fifo:out_data -> done_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> done_s1_agent:cp_data
	...
	wire  [96:0] swap_s1_agent_rf_source_data;                                                       // swap_s1_agent:rf_source_data -> swap_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] swap_s1_agent_rsp_fifo_out_data;                                                    // swap_s1_agent_rsp_fifo:out_data -> swap_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> swap_s1_agent:cp_data
	...
	wire  [96:0] bb_we_s1_agent_rf_source_data;                                                      // bb_we_s1_agent:rf_source_data -> bb_we_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] bb_we_s1_agent_rsp_fifo_out_data;                                                   // bb_we_s1_agent_rsp_fifo:out_data -> bb_we_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> bb_we_s1_agent:cp_data
	...
	wire  [96:0] waddr_s1_agent_rf_source_data;                                                      // waddr_s1_agent:rf_source_data -> waddr_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] waddr_s1_agent_rsp_fifo_out_data;                                                   // waddr_s1_agent_rsp_fifo:out_data -> waddr_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> waddr_s1_agent:cp_data
	...
	wire  [96:0] din_s1_agent_rf_source_data;                                                        // din_s1_agent:rf_source_data -> din_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] din_s1_agent_rsp_fifo_out_data;                                                     // din_s1_agent_rsp_fifo:out_data -> din_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> din_s1_agent:cp_data
	...
	wire  [95:0] done_s1_agent_rp_data;                                                              // done_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [95:0] swap_s1_agent_rp_data;                                                              // swap_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [95:0] bb_we_s1_agent_rp_data;                                                             // bb_we_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [95:0] waddr_s1_agent_rp_data;                                                             // waddr_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [95:0] din_s1_agent_rp_data;                                                               // din_s1_agent:rp_data -> router_009:sink_data
